...
// parseDFk parses the output of "df -kP".
// Columns (POSIX): Filesystem 1024-blocks Used Available Capacity Mounted-on.
...
// parseDFi parses the output of "df -iP".
// Columns (POSIX): Filesystem Inodes IUsed IFree IUse% Mounted-on.
...
// parsePercent parses a percentage string like "42%" or "-" (no inodes on this fs).
